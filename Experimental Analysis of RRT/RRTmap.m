% RRTmap Class for rapidly-exploring random tree navigation in 
% environments with obstacles with a point bicycle model.
%
% A concrete subclass of the abstract Navigation class that implements the rapidly
% exploring random tree (RRTmap) algorithm.  This is a kinodynamic planner
...
%        rrt = RRTmap(veh, 'goal', goal, 'range', 5);
...
% Peter Corke 8/2009.
% Modified by G. Fainekos to support polygonal environments
...
classdef RRTmap < Navigation
    ...
    methods
        ...
        function rrt = RRTmap(vehicle, varargin)
